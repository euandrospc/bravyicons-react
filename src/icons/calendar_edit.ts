 ...
 */
 const CalendarEdit = createBravyIconsComponent("CalendarEdit", [
    ...
    ["path", { d: "M18.7001 16.28C19.0001 17.36 19.8401 18.2 20.9201 18.5", stroke: "currentColor", key: "k4" }],
    ["path", { d: "M12 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5V12", stroke: "currentColor", key: "k5" }],
