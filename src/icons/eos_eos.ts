 ...
 */
 const EosEos = createBravyIconsComponent("EosEos", [
    ...
    ["path", { d: "M16.8002 8.5L12.5002 20.7C12.3002 21.1 11.7002 21.1 11.6002 20.7L7.2002 8.5", stroke: "currentColor", key: "k1" }]
]);

export default EosEos;
