 ...
 */
 const Key = createBravyIconsComponent("Key", [
    ...
    ["path", { d: "M6.89001 17.49L9.19001 19.79", stroke: "currentColor", key: "k1" }],
    ["path", { d: "M14.5 11C15.3284 11 16 10.3284 16 9.5C16 8.67157 15.3284 8 14.5 8C13.6716 8 13 8.67157 13 9.5C13 10.3284 13.6716 11 14.5 11Z", stroke: "currentColor", key: "k2" }]
]);
