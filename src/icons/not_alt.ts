 ...
 */
 const NotAlt = createBravyIconsComponent("NotAlt", [
    ...
    ["path", { d: "M8.5 15.5L15.5 8.5", stroke: "currentColor", key: "k1" }],
    ["path", { d: "M15.5 15.5L8.5 8.5", stroke: "currentColor", key: "k2" }]
]);

export default NotAlt;
