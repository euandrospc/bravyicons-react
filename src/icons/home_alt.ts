 ...
 */
 const HomeAlt = createBravyIconsComponent("HomeAlt", [
    ...
    ["path", { d: "M12 15.5C13.3807 15.5 14.5 14.3807 14.5 13C14.5 11.6193 13.3807 10.5 12 10.5C10.6193 10.5 9.5 11.6193 9.5 13C9.5 14.3807 10.6193 15.5 12 15.5Z", stroke: "currentColor", key: "k1" }]
]);
