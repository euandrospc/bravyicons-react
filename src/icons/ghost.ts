 ...
 */
 const Ghost = createBravyIconsComponent("Ghost", [
    ...
    ["path", { d: "M8 14C10.37 15.78 13.63 15.78 16 14", stroke: "currentColor", key: "k1" }],
    ["path", { d: "M12 11C13.1046 11 14 10.1046 14 9C14 7.89543 13.1046 7 12 7C10.8954 7 10 7.89543 10 9C10 10.1046 10.8954 11 12 11Z", stroke: "currentColor", key: "k2" }]
]);
