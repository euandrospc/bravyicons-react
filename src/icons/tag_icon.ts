 ...
 */
 const TagIcon = createBravyIconsComponent("TagIcon", [
    ...
    ["path", { d: "M9.5 12C10.8807 12 12 10.8807 12 9.5C12 8.11929 10.8807 7 9.5 7C8.11929 7 7 8.11929 7 9.5C7 10.8807 8.11929 12 9.5 12Z", stroke: "currentColor", key: "k1" }]
]);
