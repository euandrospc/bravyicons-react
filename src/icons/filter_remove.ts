 ...
 */
 const FilterRemove = createBravyIconsComponent("FilterRemove", [
    ...
    ["path", { d: "M21.63 14.75C21.63 15.64 21.38 16.48 20.94 17.2C20.12 18.58 18.61 19.5 16.88 19.5C15.15 19.5 13.64 18.57 12.82 17.2C12.38 16.49 12.13 15.64 12.13 14.75C12.13 12.13 14.26 10 16.88 10C19.5 10 21.63 12.13 21.63 14.75Z", stroke: "currentColor", key: "k1" }],
    ["path", { d: "M18.15 15.99L15.64 13.48", stroke: "currentColor", key: "k2" }],
    ["path", { d: "M18.13 13.51L15.62 16.02", stroke: "currentColor", key: "k3" }],
