 ...
 */
 const LampCharge = createBravyIconsComponent("LampCharge", [
    ["path", { d: "M12.0001 7.88989L10.9301 9.74989C10.6901 10.1599 10.8901 10.4999 11.3601 10.4999H12.6301C13.1101 10.4999 13.3001 10.8399 13.0601 11.2499L12.0001 13.1099", stroke: "currentColor", key: "k0" }],
    ...
    ["path", { d: "M8.5 22C10.79 21.35 13.21 21.35 15.5 22", stroke: "currentColor", key: "k2" }]
]);
