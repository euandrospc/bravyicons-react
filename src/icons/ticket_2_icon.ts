 ...
 */
 const Ticket2Icon = createBravyIconsComponent("Ticket2Icon", [
    ...
    ["path", { d: "M16.2111 6.7225H7.12109L10.0511 3.7925C12.4411 1.4025 13.6411 1.4025 16.0311 3.7925L16.6311 4.3925C16.0011 5.0225 15.8511 5.9525 16.2111 6.7225Z", stroke: "currentColor", key: "k1" }],
    ["path", { d: "M9.87891 6.72266L9.87891 21.7227", stroke: "currentColor", key: "k2" }]
]);
