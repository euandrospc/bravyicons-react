 ...
 * @returns {JSX.Element} JSX Element
 */
declare const CallcenterHelp: BravyIconsIcon;
...
declare namespace index {
  export {
    ...
    CallcenterHelp as CallcentarHelp,
